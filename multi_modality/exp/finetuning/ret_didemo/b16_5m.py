...
train_file = [
    ...
    f"/YOUR_PATH/data/umt_data/didemo_ori/train_videos_mp4",
    "video",
]
test_file = dict(
    val=[
        f"{anno_root_downstream}/didemo_ret_val.json",
        f"/YOUR_PATH/data/umt_data/didemo_ori/val_videos_mp4",
        "video",
    ],
    test=[
        f"{anno_root_downstream}/didemo_ret_test.json",
        f"/YOUR_PATH/data/umt_data/didemo_ori/test_videos_mp4",
        "video",
    ],
)
test_types = ["val"]
...
wandb = dict(
    ...
    project="umt_ret_didemo",  # setup in your command line
)
dist_url = "env://"
device = "cuda"
mode = "pt"
